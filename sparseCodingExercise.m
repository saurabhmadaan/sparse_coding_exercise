...
% Uncomment the below line to display the numerical and analytic gradients side by side
% disp([numgrad grad]);     
...
for iteration = 1:200                      
    ...
    %   optimization.
    sst = (featureMatrix*featureMatrix');
    weightMatrix = patches*featureMatrix'*inv(sst + gamma*eye(size(sst)));
