...
%                   otherwise.
    ...
    % -------------------- YOUR CODE HERE --------------------
    cost = trace((weightMatrix*featureMatrix-patches)'*(weightMatrix*featureMatrix-patches)) ... 
         +lambda*sum(sum(sqrt(featureMatrix.^2+epsilon))) + gamma*trace(weightMatrix'*weightMatrix);     
